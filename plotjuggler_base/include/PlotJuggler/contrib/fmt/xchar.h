...
template <
    typename Locale, typename S, typename Char = char_t<S>,
...
template <
    typename Locale, typename S, typename... Args, typename Char = char_t<S>,
    FMT_ENABLE_IF(detail::is_locale<Locale>::value&& detail::is_exotic_char<Char>::value)>
...
template <typename Locale, typename S, typename OutputIt, typename... Args,
          ...
          FMT_ENABLE_IF(
              detail::is_output_iterator<OutputIt, Char>::value&&
