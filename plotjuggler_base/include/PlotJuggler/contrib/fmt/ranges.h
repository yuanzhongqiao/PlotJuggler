...
// are not found.
template <typename T>
auto range_begin(T&& rng) -> enable_if_t<!has_member_fn_begin_end_t<T&&>::value,
...
struct range_to_view<T, enable_if_t<has_const_begin_end<T>::value>>
{
  ...
  static auto view(const T& range) -> view_t
  {
    return { &range };
  }
};
...
template <typename T>
struct range_to_view<
    T, enable_if_t<!has_const_begin_end<T>::value && has_mutable_begin_end<T>::value>>
{
  struct view_t
  {
    T m_range_copy;
