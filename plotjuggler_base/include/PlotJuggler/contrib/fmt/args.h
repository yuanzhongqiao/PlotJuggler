...
private:
  ...
  void emplace_arg(const detail::named_arg<char_type, T>& arg)
  {
    ...
    std::unique_ptr<std::vector<basic_format_arg<Context>>, decltype(pop_one)> guard{
      &data_, pop_one
    };
...
public:
  ...
  */
  ...
  {
    static_assert(need_copy<T>::value, "objects of built-in types and string views are "
                                       "always copied");
    emplace_arg(arg.get());
  }
  ...
  */
  ...
  {
    FMT_ASSERT(new_cap >= new_cap_named, "Set of arguments includes set of named "
                                         "arguments");
